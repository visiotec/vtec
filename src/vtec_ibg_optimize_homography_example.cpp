...
int main(int argc, char** argv){
   ...
   reference_image.loadPGM(refFileNameStream.str().c_str());
   ...
   current_image.loadPGM(currFileNameStream.str().c_str());
   ...
   /* Draws the region of interest in the reference image */
   drawResult(BBOX_SIZE_X, BBOX_SIZE_Y, H, reference_image); 
   ...
   std::string annotated_current_image_path, annotated_reference_image_path, current_template_path, reference_template_path;
   annotated_current_image_path = directory + "/res/annotated_current_image.pgm";
   annotated_reference_image_path = directory + "/res/annotated_reference_image.pgm";
   current_template_path = directory + "/res/warped_template.pgm";
   reference_template_path = directory + "/res/reference_template.pgm";

   current_image.savePGM(annotated_current_image_path.c_str());
   current_template.savePGM(current_template_path.c_str());
   reference_template.savePGM(reference_template_path.c_str());
   reference_image.savePGM(annotated_reference_image_path.c_str());
